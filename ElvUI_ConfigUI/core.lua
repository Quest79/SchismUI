...
login:SetScript("OnEvent", function(self)
	...
	if ElvuiConfigAll[myPlayerRealm][myPlayerName] == true then
		print(L.core_welcome1..E.version.." |cff990000Schism|r|cffFF1414.R5|r (Loaded "..myPlayerName.."'s settings)")
	else
		print(L.core_welcome1..E.version.." |cff990000Schism|r|cffFF1414.R5|r (Loaded default settings)")
	end
end)
...
function CreateElvuiConfigUI()
	...
	ElvuiConfigUITitleBox:SetTemplate("Transparent", true)
	...
	ElvuiConfigUIBG:SetTemplate("Transparent", true)
	...
	groupsBG:SetTemplate("Transparent", true)
	...
	slider:SetTemplate("Transparent", true)
	...
	for group in pairs(ALLOWED_GROUPS) do
		...
		for option,value in pairs(C[group]) do
			...
			elseif type(value) == "table" then
				...
				colorbutton:SetTemplate("Transparent", true)
	...
	reset:SetTemplate("Transparent", true)
	...
	close:SetTemplate("Transparent", true)
	...
	load:SetTemplate("Transparent", true)
