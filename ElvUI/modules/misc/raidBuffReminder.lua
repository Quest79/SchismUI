...
local bsize = (((E.minimapsize) - (E.Scale(4) * E.Scale(7))) / E.Scale(6))

--Create the Main bar
local raidbuff_reminder = CreateFrame("Frame", "RaidBuffReminder", ElvuiMinimap)
raidbuff_reminder:CreatePanel("Default", E.minimapsize, bsize + E.Scale(8), "TOPLEFT", ElvuiMinimapStatsLeft, "BOTTOMLEFT", 0, E.Scale(-1))
...
local function CreateButton(name, relativeTo, firstbutton)
	...
	button.FrameBackdrop:SetTemplate("Transparent", true)
...
do
	...
	ElvuiInfoRightLButton:SetScript("OnEnter", function(self)
		...
		ElvuiInfoRightLButton:SetTemplate("ClassColor", true)
		ElvuiInfoRightLButton:CreateShadow("ClassColor")
		ElvuiInfoRightLButton:SetPoint("TOP", 0, 2)
	...
	ElvuiInfoRightLButton:SetScript("OnLeave", function(self)
		ElvuiInfoRightLButton:SetTemplate("Transparent", true)
		ElvuiInfoRightLButton:CreateShadow("Default")
		ElvuiInfoRightLButton:SetPoint("TOP", 0, -1)
		ElvuiInfoRightLButton.hovered = false
		GameTooltip:Hide()
	end)
end