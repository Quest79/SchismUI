...
local function CreateButton(name, parent, template, width, height, point, relativeto, point2, xOfs, yOfs, text, texture)
	...
	if text then
		...
		t:SetFont(C.media.pixel,9,"OUTLINE, MONOCHROME")
		t:SetPoint("CENTER")
...
CreateButton("ShowButton", RaidUtilityPanel, "UIMenuButtonStretchTemplate, SecureHandlerClickTemplate", RaidUtilityPanel:GetWidth() / 2, E.Scale(18), "TOP", UIParent, "TOP", -300, 2, L.core_raidutil, nil)
