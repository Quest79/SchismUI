...
local hpHeight = 8
local hpWidth = 90
local iconSize = 24		--Size of all Icons, RaidIcon/ClassIcon/Castbar Icon
local cbHeight = 4
local cbWidth = 90
...
local function SkinObjects(frame)
	...
	hp.level:SetShadowColor(0, 0, 0, 0.2)
