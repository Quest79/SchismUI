...
local function SkinObjects(frame)
	...
	hp.level:SetShadowColor(1, 0, 0, 0.4)
	...
	if C["nameplate"].showhealth == true then
		...
		hp.value:SetShadowColor(1, 0, 0, 0.4)
	...
	cb.time:SetShadowColor(1, 0, 0, 0.4)
	...
	cb.name:SetShadowColor(1, 0, 0, 0.4)
