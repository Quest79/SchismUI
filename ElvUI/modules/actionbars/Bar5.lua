...
function E.PositionBar5()
	for i= 1, 8 do
		...
		if E.lowversion ~= true then
			if E["actionbar"].splitbar == true and E["actionbar"].bottomrows == 2 then
				...
				elseif i == 9 then
					b:SetPoint("TOPLEFT", ElvuiSplitActionBarLeftBackground2, "TOPLEFT", E.buttonspacing, -E.buttonspacing)
				elseif i == 11 then
					b:SetPoint("TOPLEFT", ElvuiSplitActionBarRightBackground2, "TOPLEFT", E.buttonspacing, -E.buttonspacing)
				else
	...
	for i= 9, 12 do
		...
		if E.lowversion ~= true then
			if E["actionbar"].splitbar2 == true and E["actionbar"].bottomrows == 2 then
				if i == 9 then
					b:SetPoint("TOPLEFT", ElvuiSplitActionBarLeftBackground2, "TOPLEFT", E.buttonspacing, -E.buttonspacing)
				elseif i == 11 then
					b:SetPoint("TOPLEFT", ElvuiSplitActionBarRightBackground2, "TOPLEFT", E.buttonspacing, -E.buttonspacing)
