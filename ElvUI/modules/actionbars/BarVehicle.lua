...
do
	for i=1, VEHICLE_MAX_ACTIONBUTTONS do
		...
		_G["ElvuiVehicleHotkey"..i]:Point("TOPRIGHT", 0, -2)
		_G["ElvuiVehicleHotkey"..i]:SetFont(C["media"].pixel, 9, "OUTLINE, MONOCHROME")
		_G["ElvuiVehicleHotkey"..i].ClearAllPoints = E.dummy
		_G["ElvuiVehicleHotkey"..i].Point = E.dummy
...
vehicle2:SetTemplate("Transparent", true)
