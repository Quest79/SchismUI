...
barloader:SetScript("OnEvent", function(self, addon)
	...
	if E["actionbar"].splitbar2 == nil then E["actionbar"].splitbar2 = true end
	...
	if E["actionbar"].splitbar == true and E["actionbar"].splitbar2 == true then
		LeftSplit:SetPoint("TOPRIGHT", ElvuiSplitActionBarLeftBackground2, "TOPLEFT", E.Scale(-4), 0)
		LeftSplit:SetPoint("BOTTOMLEFT", ElvuiSplitActionBarLeftBackground2, "BOTTOMLEFT", E.Scale(-19), 0)
		LeftSplit.Text:SetText(">")
		
		RightSplit:SetPoint("TOPLEFT", ElvuiSplitActionBarRightBackground2, "TOPRIGHT", E.Scale(4), 0)
		RightSplit:SetPoint("BOTTOMRIGHT", ElvuiSplitActionBarRightBackground2, "BOTTOMRIGHT", E.Scale(19), 0)
		RightSplit.Text:SetText("<")
	elseif E["actionbar"].splitbar == true and E["actionbar"].splitbar2 ~= true then
	...
	if C["actionbar"].bottompetbar == true and (select(1, HasPetUI())) == 1 then
		TopMainBar:SetPoint("BOTTOMLEFT", ElvuiPetActionBarBackground, "TOPLEFT", 0, E.Scale(4))
		TopMainBar:SetPoint("TOPRIGHT", ElvuiPetActionBarBackground, "TOPRIGHT", 0, E.Scale(19))
	else
