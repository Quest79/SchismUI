...
SetFont = function(obj, font, size, style, r, g, b, sr, sg, sb, ab, sox, soy)
	obj:SetFont(font, size, style)
	if sr and sg and sb then obj:SetShadowColor(sr, sg, sb, ab) end
...
ElvuiFonts:SetScript("OnEvent", function(self, event, addon)
	...
	-- Base fonts
	SetFont(GameTooltipHeader,                  	NORMAL, C["general"].fontscale+4, nil, nil, nil, nil, 0, 0, 0, 1, 1, -.5)
	...
	SetFont(NumberFont_Outline_Med,             	NORMAL, 11, "OUTLINE, MONOCHROME")
	SetFont(NumberFont_Shadow_Med,             		NORMAL, C["general"].fontscale, "THINOUTLINE", nil, nil, nil, 0, 0, 0, .35, 1.5, -1.5) --chat editbox uses this
	...
	SetFont(Tooltip_Med,                        	NORMAL, C["general"].fontscale, nil, nil, nil, nil, 0, 0, 0, 1, 1, -.5)
	SetFont(Tooltip_Small,                      	NORMAL, C["general"].fontscale, nil, nil, nil, nil, 0, 0, 0, 1, 1, -.5)
	SetFont(ZoneTextString,							NORMAL, 32, "OUTLINE")
	SetFont(SubZoneTextString,						NORMAL, 25, "OUTLINE")
	SetFont(PVPInfoTextString,						NORMAL, 22, "THINOUTLINE")
	SetFont(PVPArenaTextString,						NORMAL, 22, "THINOUTLINE")
	SetFont(CombatTextFont,                     	COMBAT, 16) -- number here just increase the font quality.
	SetFont(GameFontHighlightLarge,					NUMBER, 12)
