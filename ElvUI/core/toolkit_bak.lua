...
local function SetTemplate(f, t, tex)
	--[[if tex then 
		local kek = f:CreateTexture(nil, "OVERLAY")
		kek:SetAllPoints()
		kek:SetTexture(C.media.normTex2)
		texture = kek
...
--[[	tt = f:CreateTexture(nil, 'OVERLAY')
	tt:SetTexture(C["media"].normTex)
	tt:SetAllPoints(f)
	tt:SetBlendMode('ALPHAKEY')
	]]--


	f:SetBackdropBorderColor(borderr, borderg, borderb, borderba)
