...
C["media"] = {
	-- fonts
	["font"] = [=[Interface\Addons\ElvUI\media\fonts\Expressway.ttf]=], -- general font of Elvui
	["uffont"] = [[Interface\AddOns\ElvUI\media\fonts\Expressway.ttf]], -- general font of unitframes
	["dmgfont"] = [[Interface\AddOns\ElvUI\media\fonts\Explora.ttf]], -- general font of dmg / sct
	["pixel"] = [[Interface\AddOns\ElvUI\media\fonts\Visitor.ttf]], -- Pixel font
	["psize"] = 9,
	...
	["shadowintensity"] = { .7 }, --Sets how shadowy shadows are. .01 to 1 least to most.
	["backdropfadecolor"] = { .07,.07,.07,0.85 }, --this is always the same as the backdrop color with an alpha of 0.8, see colors.lua
	["valuecolor"] = {classcolor.r,classcolor.g,classcolor.b,1}, -- color for values of datatexts
...
C["framesizes"] = {
	...
	["playtarheight"] = 42,					--height of player/target frame
	["smallwidth"] = 100,					--Width of TargetTarget, Focus, FocusTarget, Player's Pet frames
	["smallheight"] = 19,					--Height of TargetTarget, Focus, FocusTarget, Player's Pet frames
	...
	["assisttankheight"] = 28,				--Height of MainTank/MainAssist frames
}
...
C["raidframes"] = {
	...
	["raidalphaoor"] = 0.1,                		-- alpha of raidframes when unit is out of range
...
C["actionbar"] = {
	["enable"] = true,                     			-- enable elvui action bars
		...
		["buttonsize"] = 32,					--size of action buttons
...
C["chat"] = {
	["enable"] = true,                     -- blah
		...
		["chatheight"] = 180,					-- height of chat frame
	...
	["bubbles"] = false,							--skin blizzard chat bubbles
}
